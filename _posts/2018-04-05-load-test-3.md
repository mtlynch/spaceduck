...
The test uploaded XX TiB of file data in XX hours. That's equivalent to an overall average upload bandwidth of XX Mbps.
...
* Sia v1.3.2 was [released](https://github.com/NebulousLabs/Sia/releases/tag/v1.3.2) a few days before this test began. All cases in this load test used 1.3.1 for consistency, the 1.3.2 release may affect results as hosts upgrade to the latest Sia version.
* At XX, I switched metrics polling from 60 second intervals to 5 minute intervals.
