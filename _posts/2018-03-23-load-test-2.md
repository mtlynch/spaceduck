...
comments: true
og_image: "/images/2018-03-23-load-test-2/storage-efficiency.png"
---
...
The test automatically terminated after 231.7 hours when absolute bandwidth dropped below 3 Mbps. This is one of the exit conditions defined in the [test plan](http://localhost:4001/files/sia-load-test-preview/load-test-plan-2018-02-14.pdf).
